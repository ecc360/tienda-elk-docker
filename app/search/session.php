                            ...
                            <div class="col-lg-3 col-md-6 col-xs-12">
                                <div class="articulo">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-1"></div>
                                        <form action="product/session.php" method="get" class="col-4"><button type="submit" class="btn btn-secondary ver-articulo" style="width: 100%;" name="id_vehiculo" value="<?php echo $row["id_vehiculo"]?>">Ver artículo</button></form>
                                    </div>
                                </div>   
                            </div>
                            <?php 
